...
7. Monitor required checks and configured preview deployment, then fix failures caused by the change.
8. Address actionable review feedback.
9. Merge only when branch protection, approvals, required checks, configured preview deployment, and repo policy allow it.
