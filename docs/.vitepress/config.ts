...
export default defineConfig({
  title: 'Sylphx Flow',
  description:
    'AI-powered development workflow automation with autonomous loop mode and smart configuration',
  base: '/',
  ...
  head: [
    ...
    [
      'meta',
      {
        ...
        content:
          'Stop writing prompts. Start building software. Autonomous AI agents with Loop Mode, File Input, and Smart Configuration.',
      },
    ],
